#/**
# * @file    libuC3aarch64fl.mak
# * @brief   Makefile for AArch64 kernel (with FPU)
# * @date    2025.02.07
...
# *            Initial version.
# *          - rev 1.1 (2018.03.27) yokota
# *            uC3krncm5.c add debug symbol.
# *          - rev 1.2 (2018.06.01) yokota
# *            add Kernel hook routine.
# *          - rev 1.3 (2018.10.16) yokota
# *            comment out TOOL_PATH.
# *          - rev 1.4 (2021.02.12) yokota
# *            change -mcpu=cortex-a53+nofp+nosimd, -march=armv8-a+nofp+nosimd.
# *          - rev 1.5 (2021.11.19) yokota
# *            move base directry.
# *            add -mfix-cortex-a53-843419, -mfix-cortex-a53-835769.
# *          - rev 1.6 (2023.08.28)
# *            change order of SRC and vpath with common rule.
# *            no code and binary change.
# *          - rev 1.7 (2025.02.07)
...
SRC2:=uC3chgims.c uC3creisr.c uC3defexc.c uC3definh.c uC3delisr.c \
      uC3dummy.c uC3krncm2.c uC3krncm3.c uC3loccpu.c uC3unlcpu.c  \
      uC3hook.c
...
CFLAGS +=-I$(incdir)/AArch64 -I$(incdir)
ifdef DEBUG
