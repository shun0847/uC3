...
# ▽▽▽ SNY 追加したフォルダパスを定義 add ▽▽▽
NXPDRV_DIR = $(PRJTOP)/../../drivers
ARCH_DIR = $(PRJTOP)/../../Core_AArch64/Include
# △△△ SNY 追加したフォルダパスを定義 add △△△
...
# ▽▽▽ SNY 追加したファイルをビルド対象に指定 add ▽▽▽
C_FILES		+=	$(wildcard $(NXPDRV_DIR)/device/*.c)
C_FILES		+=	$(wildcard $(NXPDRV_DIR)/common/*.c)
C_FILES		+=	$(wildcard $(NXPDRV_DIR)/flexcan/*.c)
C_FILES		+=	$(wildcard $(NXPDRV_DIR)/ii2c/*.c)
# △△△ SNY 追加したファイルをビルド対象に指定 add △△△
...
INCLUDES	+= -I$(SRCTOP)
# ▽▽▽ SNY 追加したファイルをビルド対象に指定 add ▽▽▽
INCLUDES	+= -I$(NXPDRV_DIR)/device
INCLUDES	+= -I$(NXPDRV_DIR)/common
INCLUDES	+= -I$(NXPDRV_DIR)/flexcan
INCLUDES	+= -I$(NXPDRV_DIR)/ii2c
INCLUDES	+= -I$(ARCH_DIR)
# △△△ SNY 追加したファイルをビルド対象に指定 add △△△
...
DEFINES += -DCONFIG_FLEXCAN_POLLING_TIMEOUT=100U
DEFINES += -DUSE_CAN2
# △△△ SNY 定義を追加 add △△△
