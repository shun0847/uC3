...
ASM_FILES	=	$(wildcard $(SRCTOP)/core1/GCC/*.S) \
				$(wildcard $(DRVTOP)/src/GCC/*.S)
C_FILES		=	$(wildcard $(SRCTOP)/*.c) \
				$(wildcard $(SRCTOP)/core1/*.c) \
				$(wildcard $(SRCTOP)/core1/GCC/*.c) \
...
LDSCRIPT	= $(SRCTOP)/core1/GCC/lscript.ld
