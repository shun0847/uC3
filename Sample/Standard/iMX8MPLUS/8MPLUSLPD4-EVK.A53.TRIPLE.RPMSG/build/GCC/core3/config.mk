...
ASM_FILES	=	$(wildcard $(SRCTOP)/core3/GCC/*.S) \
				$(wildcard $(DRVTOP)/src/GCC/*.S)
C_FILES		=	$(wildcard $(SRCTOP)/*.c) \
				$(wildcard $(SRCTOP)/core3/*.c) \
				$(wildcard $(SRCTOP)/core3/GCC/*.c) \
...
LDSCRIPT	= $(SRCTOP)/core3/GCC/lscript.ld
...
DEFINES += -D__IMX8_A5X__ -DUSE_UC3_TRIPLE_SAMPLE
