...
const T_MEM_CFG mem_cfgtbl0[] = {
  ...
  /*                   SIZE,                  PADDR,                     VADDR,        AP,    ATTR */
    ...
    {0x0000000000600000ULL, 0x0000000040A00000ULL, 0x0000000040A00000ULL, AP_RWNA, ATTR_WB }, /* Data */
    {0x0000000000100000ULL, 0x0000000041600000ULL, 0x0000000041600000ULL, AP_RWNA, ATTR_NC }, /* Data(no-cache) */
    {0x0000000000400000ULL, 0x0000000041800000ULL, 0x0000000041800000ULL, AP_RWNA, ATTR_WB }, /* System data */
    {0x0000000000100000ULL, 0x0000000042000000ULL, 0x0000000042000000ULL, AP_RWNA, ATTR_WB }, /* MMU TTB data */
    {0x0000000000200000ULL, 0x0000000042200000ULL, 0x0000000042200000ULL, AP_RWNA, ATTR_WB }, /* Stack(SP0, SP1) */
...
const T_MEM_CFG mem_cfgtbl1[] = {
  ...
  /*                   SIZE,                  PADDR,                     VADDR,        AP,    ATTR */
    ...
    {0x0000000000600000ULL, 0x0000000040A00000ULL, _H(0x0000000040A00000ULL), AP_RWNA, ATTR_WB }, /* Data */
    {0x0000000000100000ULL, 0x0000000041600000ULL, _H(0x0000000041600000ULL), AP_RWNA, ATTR_NC }, /* Data(no-cache) */
    {0x0000000000400000ULL, 0x0000000041800000ULL, _H(0x0000000041800000ULL), AP_RWNA, ATTR_WB }, /* System data */
    {0x0000000000100000ULL, 0x0000000042000000ULL, _H(0x0000000042000000ULL), AP_RWNA, ATTR_WB }, /* MMU TTB data */
    {0x0000000000200000ULL, 0x0000000042200000ULL, _H(0x0000000042200000ULL), AP_RWNA, ATTR_WB }, /* Stack(SP0, SP1) */
