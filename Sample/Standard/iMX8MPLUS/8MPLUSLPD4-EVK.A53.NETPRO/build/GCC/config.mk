...
C_FILES		+=	$(DRVTOP)/src/DDR_IMX8_ENET.c \
				...
				$(APPTOP)/http_client.c \
				$(APPTOP)/sntp_server.c \
				$(APPTOP)/ftp_client.c \
				$(APPTOP)/pop3_client.c \
				$(APPTOP)/smtp_client.c \
				$(APPTOP)/telnet_server.c \
				$(APPTOP)/tftp_client.c \
				$(APPTOP)/base64calc.c \
				$(APPTOP)/md5calc.c \
				$(SPLTOP)/shell.c \
				$(SPLTOP)/ffsys.c \
				$(SPLTOP)/app/sample_app.c \
				$(SPLTOP)/app/sample_tftp.c \
				$(SPLTOP)/app/sample_ftp.c \
				$(SPLTOP)/app/sample_http.c \
				$(SPLTOP)/app/sample_pop3.c \
				$(SPLTOP)/app/sample_smtp.c \
				$(SPLTOP)/app/sample_sntp.c \
				$(SPLTOP)/app/sample_telnetd.c \
