...
#define CFG_KRN_SYSMEM_SZ       (0x010000U)
/* Stack memory size (byte) */
#define CFG_KRN_STKMEM_SZ       (0x010000U)
...
#define CFG_KRN_TSKID_MAX       (10U)
#define CFG_KRN_SEMID_MAX       (15U)
