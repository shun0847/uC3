...
const T_MEM_CFG mem_cfgtbl0[] = {
        ...
        /* CPU core #2 */
        /*                   SIZE,                  PADDR,                      VADDR,      AP,    ATTR */
        {   0x0000000000100000ULL,  0x0000000096000000ULL,      0x0000000096000000ULL, AP_RWNA, ATTR_WB  }, /* Code */
        {   0x0000000000700000ULL,  0x0000000096100000ULL,      0x0000000096100000ULL, AP_RWNA, ATTR_WB  }, /* Data */
        {   0x0000000000100000ULL,  0x0000000096800000ULL,      0x0000000096800000ULL, AP_RWNA, ATTR_NC  }, /* Data(no-cache) */
        {   0x0000000000400000ULL,  0x0000000096900000ULL,      0x0000000096900000ULL, AP_RWNA, ATTR_WB  }, /* System data */
        {   0x0000000000100000ULL,  0x0000000096D00000ULL,      0x0000000096D00000ULL, AP_RWNA, ATTR_WB  }, /* MMU TTB data */
        {   0x0000000000200000ULL,  0x0000000096E00000ULL,      0x0000000096E00000ULL, AP_RWNA, ATTR_WB  }, /* Stack */
...
const T_MEM_CFG  mem_cfgtbl1[] = {
        ...
        /* CPU core #2 */
        /*                   SIZE,                  PADDR,                          VADDR,      AP,    ATTR */
        {   0x0000000000100000ULL,  0x0000000096000000ULL,      _H(0x0000000096000000ULL), AP_RWNA, ATTR_WB  }, /* Code */
        {   0x0000000000700000ULL,  0x0000000096100000ULL,      _H(0x0000000096100000ULL), AP_RWNA, ATTR_WB  }, /* Data */
        {   0x0000000000100000ULL,  0x0000000096800000ULL,      _H(0x0000000096800000ULL), AP_RWNA, ATTR_NC  }, /* Data(no-cache) */
        {   0x0000000000400000ULL,  0x0000000096900000ULL,      _H(0x0000000096900000ULL), AP_RWNA, ATTR_WB  }, /* System data */
        {   0x0000000000100000ULL,  0x0000000096D00000ULL,      _H(0x0000000096D00000ULL), AP_RWNA, ATTR_WB  }, /* MMU TTB data */
        {   0x0000000000200000ULL,  0x0000000096E00000ULL,      _H(0x0000000096E00000ULL), AP_RWNA, ATTR_WB  }, /* Stack */
