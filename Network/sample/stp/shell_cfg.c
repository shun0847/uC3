...
EXT_FUNC(shell_usr_cmd_rstp);
EXT_FUNC(shell_usr_cmd_mac);
...
const T_SHELL_CMD_TBL shell_cmd_tbl[] = {
    ...
    {shell_usr_cmd_ping, "ping", "Ping Request", "", 1},
#ifdef IPV6_SUP
...
#endif
#if SAMPLE_ENA_MQTTc
    {shell_usr_cmd_mqtt,    "mqtt",     "mqtt commands", "", 0},
#endif

    /* RSTP */
    {shell_usr_cmd_rstp,    "rstp",       "Display port status",   "",         0},
    {shell_usr_cmd_mac,     "mac",       "rstp ?",   "",         0},
