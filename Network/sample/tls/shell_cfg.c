...
#if SAMPLE_ENA_SSL
EXT_FUNC(shell_usr_cmd_ssl);
EXT_FUNC(shell_usr_cmd_sslconf);
#endif
...
#endif
#if SAMPLE_ENA_MQTTc
    {shell_usr_cmd_mqtt,    "mqtt",     "mqtt commands", "", 1},
#endif

#if SAMPLE_ENA_SSL
    {shell_usr_cmd_ssl, "ssl", "SSL Sample", "<server ip> <path>", 2},
    {shell_usr_cmd_sslconf, "ssl_conf", "Show TLS configuration", "", 0},
#endif
