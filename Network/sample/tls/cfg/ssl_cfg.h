...
#define CFG_SSL_CERT_SIZE       4096     /* Max certification size */
#define CFG_SSL_CERT_DEPTH      4     /* Max certification depth */
#define CFG_SSL_MAX_SESSION     2     /* Max number of sessions */
#define CFG_SSL_MAX_CONNECTION  2     /* Max number of connections */
#define CFG_SSL_CA_CERT_MAX     2     /* Max number of certificate authority */
...
#define SSL_NET_BUF_MPF_SZ      1800     /* Memory block size (ID_SSL_MPF) */
