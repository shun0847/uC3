...
const char index_html1[] = 
    ...
    "<br><br>"
    "<hr size=4>"
    "<font size=6><b>uNet3 Network Sample Applicatoin</b></font>"
    "<hr size=4>"
    "<br><br>"
    ...
    "<td>Host Name</td>"
    "<td><input type=TEXT name=fqdn value=eforce.co.jp></td>"
    "<td rowspan=\"2\"><input type=submit name=btn value=DNS></td>"
    "</tr>"
    "<tr>"
    "<td>DNS Server (IPv4)</td>"
    "<td><input type=TEXT name=dns value=192.168.1.1></td>"
    "</tr>"
    "</table>"
    "</form>"
    "</center>"
    ...
    "Powered by uC3, eForce Co.,Ltd.</a></div>"
    "</html>"
;
