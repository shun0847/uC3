...
static const T_CTSK net_ctsk_console = {
    TA_HLNG|TA_FPU, (VP_INT)0, (FP)net_console_tsk, 6U, 0x1800U, 0U, "Shell(UART)"};
#else
static const T_CTSK net_ctsk_console = {
    TA_HLNG|TA_FPU, (VP_INT)0, (FP)net_console_tsk, 6U, 0x800U, 0U, "Shell(UART)"};
#endif
...
/* DHCP Client */
    ...
    dhcp_addr.dev_num = SAMPLE_SOCDEV_CLI;
