...
SRC1:=net_udp.c net_arp.c net_buf.c net_dev.c net_icmp.c net_igmp.c           \
      net_ini.c net_ip4.c net_ipr.c net_soc.c net_sts.c net_tcp.c net_tim.c
...
CFLAGS +=-I$(incdir)
CFLAGS +=-DPOSIX_API_SUP -DEXT_ALOC_SUP
ifdef DEBUG
