 ...
 *
 * $Header:     commondef.h
 * $Contents:   common definitions for device driver header
 * $Author:     Santosh
 *
 * $Version:            $Update:
 *    2008.12.13:  First release
 *    2014.07.14:  Timestamp format fix.
 ************************************************************************/
...
#define _p32_REG(X)         (*(volatile UW *)(X))
#define _p16_REG(X)         (*(volatile UH *)(X))
#define _p8_REG(X)          (*(volatile UB *)(X))
